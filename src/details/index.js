        ...
        <div class="container py-lg-4 py-md-3 py-2">
          <div class="inner mb-4">
            <ul class="blog-single-author-date align-items-center">
              ...
              <li>
                <span class="fa fa-clock-o"></span> 5 months ago
              </li>
              <li>
                <span class="fa fa-eye"></span> 250 views
              </li>
            </ul>
          </div>
          ...
          <div class="blo-singl mb-4">
            <ul class="blog-single-author-date align-items-center">
              ...
              <li>
                <span class="fa fa-bath"></span> 4 Baths
              </li>
              <li>
                <span class="fa fa-share-square-o"></span> 1258 sqrft
              </li>
            </ul>
            <ul class="share-post">
            ...
            <div class="sidebar-side col-lg-4 col-md-12 col-sm-12 mt-lg-0 mt-5">
              <aside class="sidebar">
                <div class="sidebar-widget popular-posts">
                  ...
                  <article class="post">
                    <figure class="post-thumb">
                      <img src={l5} class="radius-image" alt="" />
                    </figure>
                    <div class="text mb-0">
                  ...
                  <button type="submit" class="btn btn-primary btn-style w-100">
                    Request details
                  </button>
                </div>
                ...
                <div class="sidebar-widget popular-posts">
                  ...
                  <article class="post">
                    <figure class="post-thumb">
                      <img src={l1} class="radius-image" alt="" />
                    </figure>
                    <div class="text">
                      <a href="#blog-single">
                  ...
                  <article class="post">
                    <figure class="post-thumb">
                      <img src={l2} class="radius-image" alt="" />
                    </figure>
                    <div class="text">
                  ...
                  <article class="post">
                    <figure class="post-thumb">
                      <img src={l3} class="radius-image" alt="" />
                    </figure>
                    <div class="text">
                      <a href="#blog-single">
