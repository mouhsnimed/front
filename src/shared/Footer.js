          ...
          <div className="footers20-content">
            <div className="d-grid grid-col-4 grids-content">
              <div className="column" >
                ...
                <h4 className="text-white"> Contacter nous, au besoin de conseils immobilier, nous sommes à votre écoute</h4>
              ...
              <div className="column">
                ...
                <h4 className="text-white">Avez vous des questions, à nous formuler ?</h4>
              ...
              <div className="column mt-lg-0 mt-md-5">
                ...
                <p className="text-white"> pour rester informé, de nos activités  </p>
