...
const Listing = () => {
  ...
  const getCategories = async () => {
    const DataFromServer = await fetchAysnc("http://localhost:8000/api/categorieAnnonce")
  ...
  const getSearch  = async function(e)
  {
    ...
    // Récupération du résultat et formatage
    const DataFromServer = await postAysnc("http://localhost:8000/api/Annonce/search",reqElement) 
  ...
  return (
    <div>
      ...
      <section style={{backgroundColor:"rgba(0,0,0,0.8)",boxShadow:"0px 2px 5px black",padding:"0px"}}>   
        <div className="container-fluid" style={{padding:"0px"}}>
          <form onSubmit={(e) => ( getSearch(e) )}>
            <div className="form-row align-items-center" 
                 style={{height:"20px",width:"100%",backgroundColor:"transparent"}}>                   
                <button type="button" className="btn btn-primary text-center" onClick={(e) => (
                    setSearchMax(!searchMax))}>                  
                    { searchMax ? <> minimal <span className="fa fa-arrow-up"></span> </>
            ...
            <div className="form-row align-items-center">
              <div className="col-sm-2 my-1 ml-2">
                <label className="text-white" htmlFor=""> Type de bail  </label>
              ...
              <div>
                <hr style={{height:"80px",width:"2px",backgroundColor:"white"}}/>
              </div>

              <div className="col-sm-2 my-1 ml-2">
                <label className="text-white" htmlFor=""> Catégorie </label>
                <select className="form-control" name="categorie_annonce" required >                     
              ...
              <div className="col-sm-2 my-1 ml-2">
                <label className="text-white" htmlFor=""> superficie (m²) </label>
                <div className="input-group">                  
                    <input type="number" name="superficie1" className="form-control mr-2"  placeholder="de"/>
                    <input type="number" name="superficie2" className="form-control"  placeholder="à"/>
                </div>
              </div>
              ...
              <div className="col-sm-2 my-1 ml-2">
                <label className="text-white" htmlFor="searchPrix1"> prix (MAD) </label>
                <div className="input-group">                  
                    <input type="number" name="prix1" id="searchPrix1" className="form-control mr-2"  placeholder="de"/>
                    <input type="number" name="prix2" id="searchPrix2" className="form-control"  placeholder="à"/>
                </div>
              </div>
              ...
              <div className="col-sm-2 my-1 ml-2">
                <label className="text-white" htmlFor="searchVille"> Localisation </label>
                <select className="form-control" name="ville" id="searchVille" required >                 
            ...
            {searchMax && 
              <>
              <hr style={{height:"1px",width:"100%",backgroundColor:"white",marginBottom:"0px",boxShadow:"5px 5px 10px black inset"}}/>
              <div className="form-row align-items-center text-center" 
                  style={{backgroundColor:"rgba(0,0,0,0.3)",padding:"10px",marginTop:"0px",boxShadow:"1px 1px 5px black inset"}}
                  >
                <div className="offset-sm-1 col-sm-2 my-1">
                  <div className="form-inline-group">
                    <label className="text-white" htmlFor="">Nbr. Chambres</label>
                    <div className="input-group">                  
                      ...
                      <input type="number" name="nbChambre" className="form-control"/>
                    </div>
                  </div>
                </div>
            
                <div className="col-sm-2 my-1 ml-2">
                  <label className="text-white" htmlFor=""> Nbr. Salle de Bain</label>
                  <div className="input-group">                  
                    <div className="input-group-prepend">
                      <div className="input-group-text bg-primary" > 
                    ...
                    <input type="number" name="nbSalleBain" className="form-control"/>
                  </div>
                </div>
            
                <div className="col-sm-2 my-1 ml-2">
                  <label className="text-white" htmlFor="">Nbr. Salons </label>
                  <div className="input-group" >                  
                    <div className="input-group-prepend">
                      <div className="input-group-text bg-primary" > 
                    ...
                    <input type="number" name="nbSalon" className="form-control"/>
                  </div>
                </div>

                <div className="col-sm-2 my-1 ml-2">
                  <label className="text-white" htmlFor=""> A quel Etage </label>
                  <div className="input-group" >                  
                    <div className="input-group-prepend">
                      <div className="input-group-text bg-primary" > 
                    ...
                    <input type="number" name="niveauEtage" className="form-control" placeholder="0"/>
                  </div>
                </div>

                <div className="col-sm-2 my-1 ml-2">
                  <label className="text-white" htmlFor=""> Meublé </label>
                  <div className="input-group" >                  
                    <div className="input-group-prepend">
                      <div className="input-group-text bg-primary" > 
                    ...
                    <select className="form-control" name="estMeuble" required >                    
            ...
            <div className="row">   
              {
                ...
                (                                           
                  (i < 9) &&         
                  <div key={annonce.id} className="col-lg-4 col-md-6 listing-img mt-lg-0 pt-lg-0 mt-5 pt-md-2 mb-3">
                    <a href="#url">
                      <div className="box16">
                    ...
                    <div className="listing-details blog-details align-self">
                      ...
                      <ul className="mt-3 estate-info">
                        <li>
                          <span className="fa fa-bed"></span> {annonce.nombre_chambre} ch
                        </li>
                        <li>
                          <span className="fa fa-shower"></span> {annonce.nombre_bain} bain
                        </li>
                        <li>
                          <span className="fa fa-share-square-o"></span> {annonce.superficie} m²
                        </li>
                      </ul>
                      {/* partie annonceur */}
